function [w, beta]=swdwdls(Ap, An, paramstruct);
%SWDWDLS L1 Sparse and Adaptive Sparse Weighted DWD
%
% Usage:
%
...
%
%    obsweight     the weights to adjust the unbalance between groups
%                  default obsweight are all ones for n observations
%                  Note that the first n1 are for the cases, and the last
%                  n2 are for the controls, the order matters!!!
%
% Outputs:
%
%    w           the normal vector
...
%
%    wdwdls.m    an experimental routine of wDWD method (Qiao et al, 2008)
...
% 2009-07-15 Adding balance weights for all
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
istandardize=0;
tol=1e-6;
DWDpar=100;
...
%%%
%%% First calculate the regular wDWD based on the DWDpar
%%%

w_dwd=wdwdls(Ap, An, paramstruct);
...
cl=[penalty*obsweight; zeros(2*d+1, 1)];
cu=0;
